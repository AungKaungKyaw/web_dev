class Slider {
    constructor() {
        ...
        this.heightItem = this.slideContent.querySelector(
            ".slide__content-item"
        ).clientHeight;
        this.autoPlay = true;
        this.duaEffect = 900;
    ...
    nextSlider() {
        ...
        Velocity(
            ...
            { opacity: 1 },
            { duration: this.duaEffect, delay: 0, queue: false, easing: "linear" }
        );
